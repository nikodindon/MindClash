"""Generate all audio segments for EP001.

Reads episodes/EP001_jancovici-synthesis/script.json, runs Kokoro TTS
...
episodes/EP001_jancovici-synthesis/audio_segments/.

Final master: episodes/EP001_jancovici-synthesis/master.wav
"""
import json
import os
import wave
...
SCRIPT_PATH = ROOT / 'episodes/EP001_jancovici-synthesis/script.json'
SEGMENTS_DIR = ROOT / 'episodes/EP001_jancovici-synthesis/audio_segments'
MASTER_PATH = ROOT / 'episodes/EP001_jancovici-synthesis/master.wav'
