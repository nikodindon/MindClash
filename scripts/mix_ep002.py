"""Mix the EP002 master.wav with intro/outro music + section stings.

Inputs:
  - episodes/EP002_lovins-synthesis/master.wav (~24 min, Kokoro TTS)
...
Output:
  - episodes/EP002_lovins-synthesis/final.wav (with music bed)
  - episodes/EP002_lovins-synthesis/final.mp3 (via ffmpeg)
"""
import wave
import os
import numpy as np
